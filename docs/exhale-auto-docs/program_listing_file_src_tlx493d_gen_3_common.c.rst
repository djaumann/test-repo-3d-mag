...
.. _program_listing_file_src_tlx493d_gen_3_common.c:

Program Listing for File tlx493d_gen_3_common.c
===============================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_tlx493d_gen_3_common.c>` (``src\tlx493d_gen_3_common.c``)
